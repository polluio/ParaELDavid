            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        Mascota mascota = buscaMascota();
                        if (mascota == null) {
                            System.out.println("no se ha encontrado ninguna mascota");
                        } else {
                            clinica.IntroducirTratamiento(mascota);
                        }
                        clinica.actualizarFicheroMascotas(mascota.duenyo);
                        break;
                    case 9:
                        mascota = buscaMascota();
                        if (mascota == null) {
                            System.out.println("no se ha encontrado ninguna mascota");
                        } else {
                            clinica.ImprimirTratamiento(mascota);
                        }

                        break;
                    case 10:
                        clinica.imprimirClientes("clientesTexto.txt");
                        break;
                ...
                System.out.println("Dame el tipo de dato q pido");
                num.nextLine();
